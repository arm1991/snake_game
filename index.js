...
import start from "./helpers/mobile.js";
import { generateRandomFoodPosition, checkFood } from "./helpers/food.js";
import {
  createDom,
  createHighestScoreTable,
  createHighestScore,
} from "./helpers/create_field.js";
import {
  changeDirection,
  switchDirection,
  handleInput,
  changeFields,
} from "./helpers/change_direction.js";
import { logInFunc } from "./helpers/log_in.js";
import { checkLose, changeDisplayWhenTheGameEnds } from "./helpers/end.js";
...
function main(store) {
  ...
  createDom(store);
  showHighScore(store);
  start(store.domElements.fields);
...
function showHighScore(store) {
  ...
  store.domElements.table.appendChild(
    createHighestScore(document.createElement("div"), store)
  );
  store.domElements.table.appendChild(
    createHighestScoreTable(document.createElement("div"), store)
  );
}
